...
pub static GRAPHICS: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("icon_folder", ColumnType::Text),
...
pub static STATION_SERVICES: TableSchema = TableSchema {
    ...
    columns: &[
        Column::required("id", ColumnType::Integer),
        Column::new("service_name", ColumnType::Localized),
    ],
    foreign_keys: &[],
    indexes: &[Index::on(&["service_name_en"])],
    child_tables: &[],
    array_source: None,
};
...
pub static CHARACTER_ATTRIBUTES: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("name", ColumnType::Localized),
        Column::new("description", ColumnType::Text),
        Column::new("short_description", ColumnType::Text),
...
pub static PLANET_RESOURCES: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("workforce", ColumnType::Integer),
        Column::new("reagent_type_id", ColumnType::Integer).json("reagent.type_id"),
        Column::new("reagent_amount_per_cycle", ColumnType::Integer)
            .json("reagent.amount_per_cycle"),
        Column::new("reagent_cycle_period", ColumnType::Integer).json("reagent.cycle_period"),
        Column::new("reagent_secured_capacity", ColumnType::Integer)
            .json("reagent.secured_capacity"),
        Column::new("reagent_unsecured_capacity", ColumnType::Integer)
            .json("reagent.unsecured_capacity"),
    ],
    foreign_keys: &[ForeignKey::new("reagent_type_id", "types")],
    indexes: &[Index::on(&["reagent_type_id"])],
    child_tables: &[],
    array_source: None,
};
...
pub static MAP_REGIONS: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("nebula_id", ColumnType::Integer),
...
pub static SKINS: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("allow_ccp_devs", ColumnType::Boolean).json("allowCCPDevs"),
...
/// Note: This JSONL uses snake_case for field names, not camelCase
pub static SOVEREIGNTY_UPGRADES: TableSchema = TableSchema {
    name: "sovereignty_upgrades",
    source_file: "sovereigntyUpgrades.jsonl",
    columns: &[
        Column::required("id", ColumnType::Integer),
        Column::new("fuel_type_id", ColumnType::Integer).json("fuel.type_id"),
        Column::new("fuel_hourly_upkeep", ColumnType::Integer).json("fuel.hourly_upkeep"),
        Column::new("fuel_startup_cost", ColumnType::Integer).json("fuel.startup_cost"),
        Column::new("mutually_exclusive_group", ColumnType::Text).json("mutually_exclusive_group"),
        Column::new("power_allocation", ColumnType::Integer).json("power_allocation"),
        Column::new("workforce_allocation", ColumnType::Integer).json("workforce_allocation"),
    ],
    foreign_keys: &[
        ForeignKey::new("id", "types"),
...
pub static BLUEPRINTS: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("copying_time", ColumnType::Integer).json("activities.copying.time"),
        Column::new("manufacturing_time", ColumnType::Integer)
            .json("activities.manufacturing.time"),
        Column::new("research_material_time", ColumnType::Integer)
            .json("activities.research_material.time"),
        Column::new("research_time_time", ColumnType::Integer)
            .json("activities.research_time.time"),
        Column::new("invention_time", ColumnType::Integer).json("activities.invention.time"),
        Column::new("reaction_time", ColumnType::Integer).json("activities.reaction.time"),
    ],
...
pub static MAP_STARS: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("radius", ColumnType::Real),
        Column::new("age", ColumnType::Real).json("statistics.age"),
        Column::new("life", ColumnType::Real).json("statistics.life"),
        Column::new("luminosity", ColumnType::Real).json("statistics.luminosity"),
        Column::new("spectral_class", ColumnType::Text).json("statistics.spectralClass"),
        Column::new("temperature", ColumnType::Real).json("statistics.temperature"),
    ],
    foreign_keys: &[
...
pub static MAP_MOONS: TableSchema = TableSchema {
    ...
    foreign_keys: &[
        ForeignKey::new("solar_system_id", "map_solar_systems"),
        ForeignKey::new("orbit_id", "map_planets"),
        ForeignKey::new("type_id", "types"),
    ],
    indexes: &[Index::on(&["orbit_id"]), Index::on(&["type_id"])],
    child_tables: &[],
    array_source: None,
};
...
pub static MAP_STARGATES: TableSchema = TableSchema {
    ...
    columns: &[
        ...
        Column::new("solar_system_id", ColumnType::Integer),
        Column::new("type_id", ColumnType::Integer),
        Column::new("destination_stargate_id", ColumnType::Integer).json("destination.stargateID"),
